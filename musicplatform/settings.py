...
SECRET_KEY = 'django-insecure-03#n0i7khl)l(vs1)rmp0857ea-cioz-xpbj_4#8@&8v1=llz-'
...
REST_KNOX = {
    ...
    'TOKEN_LIMIT_PER_USER': 2,  # By default, this option is disabled and set to None -- thus no limit.
    'AUTO_REFRESH': False,
